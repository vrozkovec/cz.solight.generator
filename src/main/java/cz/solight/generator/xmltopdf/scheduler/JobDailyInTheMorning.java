 ...
 * @author rozkovec
 */
public class JobDailyInTheMorning extends WicketAppBoundJob<PdfGeneratorApplication>
{
	private static final Logger log = LoggerFactory.getLogger(JobDailyInTheMorning.class);

	/**
	 * Construct.
	 */
	public JobDailyInTheMorning()
	{
	}
