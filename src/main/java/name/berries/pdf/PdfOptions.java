 ...
 * 
 * Encapsulates all the settings needed to customize PDF output including
 * page format, margins, orientation, and rendering behavior.
 */
public class PdfOptions {
     ...
     * 
     * @param format Page format (A4, A3, Letter, Legal, Tabloid, Ledger, 
     *               or custom size like "100mm:200mm")
     */
     ...
     * Sets the top margin.
     * 
     * @param marginTop Margin size (e.g., "10mm", "1in", "20px")
     */
     ...
     * 
     * @param marginBottom Margin size (e.g., "10mm", "1in", "20px")
     */
     ...
     * 
     * @param marginLeft Margin size (e.g., "10mm", "1in", "20px")
     */
     ...
     * 
     * @param marginRight Margin size (e.g., "10mm", "1in", "20px")
     */
     ...
     * 
     * @param printBackground true to include backgrounds, false to omit them
     */
     ...
     * 
     * @param waitFor Wait condition: "networkidle", "load", or timeout in milliseconds
     */
    ...
    /**
     * Adds an external stylesheet URL that will be loaded before PDF generation.
     * These stylesheets will be available to both main content and header/footer templates.
     * 
     * @param stylesheetUrl URL to CSS file (http://, https://, or file:// URL)
     */
     ...
     * 
     * @param stylesheetUrls List of CSS URLs
     */
    ...
    /**
     * Sets the header template HTML.
     * Use special CSS classes: pageNumber, totalPages, url, title, date
     * 
     * @param headerTemplate HTML template for header
     */
    ...
    /**
     * Sets the footer template HTML.
     * Use special CSS classes: pageNumber, totalPages, url, title, date
     * 
     * @param footerTemplate HTML template for footer
     */
    ...
    /**
     * Enables or disables header and footer display.
     * Must be true to show headerTemplate and footerTemplate.
     * 
     * @param displayHeaderFooter true to show headers/footers
     */
     ...
     * 
     * @param margin Margin size for all sides (e.g., "10mm", "1in", "20px")
     */
